...
const age = 23;
age >= 18 ? console.log("I like to drink wine🍷") : console.log("I like to drink water🥤"); //expression

const drink = age >= 18 ? "wine🍷" : "water🥤"; //ternary opr
console.log(drink);
...
const tip = bill>50 && bill<300 ? (bill*15)/100 : bill*0.20;
